...
use profiles::commands::{
  ...
  profile_history_list, profile_history_remove, profile_launch, profile_list, profile_logs,
  profile_open_path, profile_quick_play_list, profile_quick_play_remove, profile_remove,
